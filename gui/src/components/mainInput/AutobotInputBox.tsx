...
interface AutobotInputBoxProps {
...
function AutobotInputBox(props: AutobotInputBoxProps) {
  ...
  return (
    <div
      ...
      data-testid={`autobot-input-box-${props.inputId}`}
    >
...
export default memo(AutobotInputBox);
